...
### 3. 일반 회원가입
![메인화면](./assets/2. 회원가입(일반).gif)

### 4. 일반 로그인
![메인화면](./assets/3. 일반로그인.gif)

### 5. 소셜 로그인
![메인화면](./assets/4. 소셜로그인.gif)

### 6. 회원 정보 불러오기
![메인화면](./assets/5. 회원정보페이지.gif)

### 7. 회원 정보 수정
![메인화면](./assets/6. 회원정보 수정.gif)

### 8. 비밀번호 변경
![메인화면](./assets/7. 비밀번호 변경.gif)

### 9. 친구 추가 보내기
![메인화면](./assets/8. 친구추가 보내기.gif)

### 10. 친구 알람 받기
![메인화면](./assets/9. 친구 알림 받기.gif)

### 11. 나의 친구 내역
![메인화면](./assets/10. 나의 친구 내역.gif)

### 12. 회의 알림 수락
![메인화면](./assets/11. 회의 알림 수락.gif)

### 13. 여행 계획 만들기
![메인화면](./assets/12. 여행 계획 만들기.gif)

### 14. 여행 계획 참여
![메인화면](./assets/13. 회의 참여.gif)

### 15. 여행 계획 관련 전체 기능 (채팅, STT를 통한 여행지 검색, 일정 선별, 공통편집)
![메인화면](./assets/14. 전체로직.gif)
