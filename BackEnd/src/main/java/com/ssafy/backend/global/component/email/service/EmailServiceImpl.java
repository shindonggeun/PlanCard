...
public class EmailServiceImpl implements EmailService {
    ...
    private MimeMessage createMessage(String toEmail, String emailCode) {
        ...
        try {
            ...
            mimeMessage.setSubject("PlanCard 이메일 인증 코드입니다.");

            String msgg = "";

            msgg += "<div style='margin:20px;'>";
            msgg += "<h1> PlanCard 회원가입 이메일 인증번호</h1>";
            msgg += "<br>";
            ...
            mimeMessage.setFrom(new InternetAddress("donggeun3484@gmail.com", "PlanCard"));
        } catch (Exception e) {
